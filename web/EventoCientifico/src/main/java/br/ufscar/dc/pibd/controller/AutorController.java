...
public class AutorController extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usuario.getMembroOrganizacaoBrasileiro() != null || usuario.getMembroOrganizacaoEstrangeiro() != null ||
        		usuario.getAvaliadorBrasileiro() != null || usuario.getAvaliadorEstrangeiro() != null) {
            Erro erro = new Erro();
