...
import br.ufscar.dc.pibd.dao.AutorEstrangeiroDAO;
import br.ufscar.dc.pibd.domain.AutorEstrangeiro;
import br.ufscar.dc.pibd.util.Erro;

@WebServlet(urlPatterns = { "/autorEstrangeiro/*" })
public class AutorEstrangeiroController extends HttpServlet{

	private static final long serialVersionUID = 1L;

    private AutorEstrangeiroDAO autorBrasileiroDao;
    
    @Override
    public void init() {
        autorBrasileiroDao = new AutorEstrangeiroDAO();
    }
    ...
    private Map<Long, String> getAutorEstrangeiro() {
        Map <Long,String> autores = new HashMap<>();
        for (AutorEstrangeiro autorBrasileiro: new AutorEstrangeiroDAO().getAll()) {
    ...
    private void insere(HttpServletRequest request, HttpServletResponse response)
        ...
        String nroPassaporte = request.getParameter("nroPassaporte");
        Data dataEmissao = request.getParameter("dataEmissao");
        ...
        AutorEstrangeiro autorBrasileiro = new AutorEstrangeiro(primeiroNome, sobrenome, cep, numero, filiacao, ddi, ddd, prefixo, numeroTelefone, login, dominio, 
